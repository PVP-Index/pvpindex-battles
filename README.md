...
- `bootstrap-paper/target/PvPIndexBattles-1.0.6.jar` - drop into Paper `plugins/`
- `bootstrap-velocity/target/PvPIndexBattles-velocity-1.0.6.jar` - drop into Velocity `plugins/`
- `bootstrap-bungeecord/target/PvPIndexBattles-bungeecord-1.0.6.jar` - drop into BungeeCord `plugins/`
